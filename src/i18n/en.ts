export const en = {
  ...
  about: {
    ...
    narrative: [
      ...
      "Currently at Asana I'm building Digital Engineering in Warsaw as Lead Creative Technologist — first engineer on the ground, first hire made. I partner daily with the Platform team in San Francisco on the full engineering stack: component system, infrastructure, on-call, and the interactive launches and campaigns that ship on asana.com. Day-to-day: hiring, coaching, shaping technical direction, and shipping code myself. I also run employer brand for our Warsaw office—campaigns, events, and the stories we tell candidates—which means I regularly coach people across functions.",
